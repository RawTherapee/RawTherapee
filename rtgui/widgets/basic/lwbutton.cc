...
LWButton::LWButton(std::shared_ptr<RTSurface> i,
                   int aCode,
                   void* aData,
                   Alignment ha,
                   Alignment va,
...
{
    // All GUI access from idle_add callbacks or separate thread HAVE to be protected
    GThreadLock lock;
    // Line width shall be even to avoid blur effect when upscaling
