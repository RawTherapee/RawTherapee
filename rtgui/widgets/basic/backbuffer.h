...
protected:
    ...
    rtengine::Coord
        offset;  // Offset of the source region to draw, relative to the top left corner
...
public:
    ...
    bool setDrawRectangle(Glib::RefPtr<Gdk::Window> window,
    ...
    bool setDrawRectangle(Glib::RefPtr<Gdk::Window> window,
                          ...
                          int newH,
                          bool updateBackBufferSize = true);
    bool setDrawRectangle(Cairo::Format format,
                          Gdk::Rectangle& rectangle,
                          bool updateBackBufferSize = true);
    bool setDrawRectangle(Cairo::Format format,
                          int newX,
    ...
    void copyRGBCharData(const unsigned char* srcData,
                         int srcX,
                         int srcY,
                         int srcW,
                         int srcH,
                         ...
                         int dstX,
                         int dstY);
    void copySurface(Glib::RefPtr<Gdk::Window> window,
                     Gdk::Rectangle* rectangle = nullptr);
    void copySurface(BackBuffer* destBackBuffer, Gdk::Rectangle* rectangle = nullptr);
    void copySurface(const Cairo::RefPtr<Cairo::ImageSurface>& destSurface,
                     Gdk::Rectangle* rectangle = nullptr);
    void copySurface(const Cairo::RefPtr<Cairo::Context>& crDest,
                     Gdk::Rectangle* destRectangle = nullptr);
    ...
    bool surfaceCreated() { return static_cast<bool>(surface); }
